...
public class MenuController : MonoBehaviour
{
	...
	public List<string> List_Written_Out_Coal_Vain_On = new List<string>();
	public List<string> List_Written_Out_Coal_Vain_On_Images = new List<string>();
	public List<string> List_Written_Out_Coal_Vain_On_Images_Texture = new List<string>();
	public List<string> List_Written_Out_Coal_Vain_On_Info = new List<string>();
    ...
    void Start()
    {
    	...
    	List_Main_Menu_1_Container_Images_Texture.Add("");
    	List_Main_Menu_1_Container_Images.Add("");
    	List_Main_Menu_1_Container_Images_Texture.Add("");
    	List_Main_Menu_1_Container_Images.Add("");
    	List_Main_Menu_1_Container_Images_Texture.Add("");
		...
		List_Main_Menu_2_Container_Images_Texture.Add("");
		List_Main_Menu_2_Container_Images.Add("");
		List_Main_Menu_2_Container_Images_Texture.Add("");
		List_Main_Menu_2_Container_Images.Add("");
		List_Main_Menu_2_Container_Images_Texture.Add("");
		...
		List_Written_Out_Coal_Vain_On_Info.Add("Coal Vain");
		List_Written_Out_Coal_Vain_On_Info.Add("Coal Vain : On");
		//New List Area AHK
		List_Written_Out_Coal_Vain_On.Add("Make 5% of Miners Work Here");
		List_Written_Out_Coal_Vain_On_Images.Add("");
		List_Written_Out_Coal_Vain_On_Images_Texture.Add("");
		List_Written_Out_Coal_Vain_On.Add("Make 10% of Miners Work Here");
		List_Written_Out_Coal_Vain_On_Images.Add("");
		List_Written_Out_Coal_Vain_On_Images_Texture.Add("");
		List_Written_Out_Coal_Vain_On.Add("Make 15% of Miners Work Here");
		List_Written_Out_Coal_Vain_On_Images.Add("");
		List_Written_Out_Coal_Vain_On_Images_Texture.Add("");
		List_Written_Out_Coal_Vain_On.Add("Make 20% of Miners Work Here");
		List_Written_Out_Coal_Vain_On_Images.Add("");
		List_Written_Out_Coal_Vain_On_Images_Texture.Add("");
		List_Written_Out_Coal_Vain_On.Add("Make 25% of Miners Work Here");
		List_Written_Out_Coal_Vain_On_Images.Add("");
		List_Written_Out_Coal_Vain_On_Images_Texture.Add("");
		List_Written_Out_Coal_Vain_On.Add("Make 30% of Miners Work Here");
		List_Written_Out_Coal_Vain_On_Images.Add("");
		List_Written_Out_Coal_Vain_On_Images_Texture.Add("");
		List_Written_Out_Coal_Vain_On.Add("Make 35% of Miners Work Here");
		List_Written_Out_Coal_Vain_On_Images.Add("");
		List_Written_Out_Coal_Vain_On_Images_Texture.Add("");
		List_Written_Out_Coal_Vain_On.Add("Make 40% of Miners Work Here");
		List_Written_Out_Coal_Vain_On_Images.Add("");
		List_Written_Out_Coal_Vain_On_Images_Texture.Add("");
		List_Written_Out_Coal_Vain_On.Add("Make 45% of Miners Work Here");
		List_Written_Out_Coal_Vain_On_Images.Add("");
		List_Written_Out_Coal_Vain_On_Images_Texture.Add("");
		List_Written_Out_Coal_Vain_On.Add("Make 50% of Miners Work Here");
		List_Written_Out_Coal_Vain_On_Images.Add("");
		List_Written_Out_Coal_Vain_On_Images_Texture.Add("");
		List_Written_Out_Coal_Vain_On.Add("Make 55% of Miners Work Here");
		List_Written_Out_Coal_Vain_On_Images.Add("");
		List_Written_Out_Coal_Vain_On_Images_Texture.Add("");
		List_Written_Out_Coal_Vain_On.Add("Make 60% of Miners Work Here");
		List_Written_Out_Coal_Vain_On_Images.Add("");
		List_Written_Out_Coal_Vain_On_Images_Texture.Add("");
		List_Written_Out_Coal_Vain_On.Add("Make 65% of Miners Work Here");
		List_Written_Out_Coal_Vain_On_Images.Add("");
		List_Written_Out_Coal_Vain_On_Images_Texture.Add("");
		List_Written_Out_Coal_Vain_On.Add("Make 70% of Miners Work Here");
		List_Written_Out_Coal_Vain_On_Images.Add("");
		List_Written_Out_Coal_Vain_On_Images_Texture.Add("");
		List_Written_Out_Coal_Vain_On.Add("Make 75% of Miners Work Here");
		List_Written_Out_Coal_Vain_On_Images.Add("");
		List_Written_Out_Coal_Vain_On_Images_Texture.Add("");
		List_Written_Out_Coal_Vain_On.Add("Make 80% of Miners Work Here");
		List_Written_Out_Coal_Vain_On_Images.Add("");
		List_Written_Out_Coal_Vain_On_Images_Texture.Add("");
		List_Written_Out_Coal_Vain_On.Add("Make 85% of Miners Work Here");
		List_Written_Out_Coal_Vain_On_Images.Add("");
		List_Written_Out_Coal_Vain_On_Images_Texture.Add("");
		List_Written_Out_Coal_Vain_On.Add("Make 90% of Miners Work Here");
		List_Written_Out_Coal_Vain_On_Images.Add("");
		List_Written_Out_Coal_Vain_On_Images_Texture.Add("");
		List_Written_Out_Coal_Vain_On.Add("Make 95% of Miners Work Here");
		List_Written_Out_Coal_Vain_On_Images.Add("");
		List_Written_Out_Coal_Vain_On_Images_Texture.Add("");
		List_Written_Out_Coal_Vain_On.Add("Make 100% of Miners Work Here");
		List_Written_Out_Coal_Vain_On_Images.Add("");
		List_Written_Out_Coal_Vain_On_Images_Texture.Add("");

		List_Written_Out_Coal_Vain.Add("Coal Vain : On");
		List_Written_Out_Coal_Vain_Images.Add("");
		List_Written_Out_Coal_Vain_Images_Texture.Add("");
		...
		List_Written_Out_1_1_1_Images_Texture.Add("");
		...
		List_Written_Out_1_1_Images_Texture.Add("");
		...
		List_Written_Out_1_1_2_Images_Texture.Add("");
		...
		List_Written_Out_1_Images_Texture.Add("");
    	...
    	List_Written_Out_1_2_Images_Texture.Add("");
    	...
    	Lists_Written_Out.Add(List_Written_Out_Coal_Vain_On);
		Lists_Written_Out_Images.Add(List_Written_Out_Coal_Vain_On_Images);
		Lists_Written_Out_Images_Texture.Add(List_Written_Out_Coal_Vain_On_Images_Texture);
		Lists_Written_Out_Info.Add(List_Written_Out_Coal_Vain_On_Info);
	    ...
	    for(var i2 = 0; i2 < 5; i2++){	
	    	for(var i = 0; i < 3; i++){
	    		if(i2 <= 2){
	    			...
	    			List_Result_1_Images_Texture[i2].GetComponent<SpriteRenderer>().sprite = Resources.Load(""+List_Main_Menu_1_Container_Images_Texture[i2], typeof(Sprite)) as Sprite;
	    		...
	    		if(i2 == 3){
	    			...
	    			List_Result_1_Images_Texture[i2].GetComponent<SpriteRenderer>().sprite = Resources.Load(""+List_Main_Menu_1_Container_Images_Texture[List_Main_Menu_1_Container_Images_Texture.Count - 2], typeof(Sprite)) as Sprite;	
	    		...
	    		if(i2 == 4){
	    			...
	    			List_Result_1_Images_Texture[i2].GetComponent<SpriteRenderer>().sprite = Resources.Load(""+List_Main_Menu_1_Container_Images_Texture[List_Main_Menu_1_Container_Images_Texture.Count - 1], typeof(Sprite)) as Sprite;	
	    ...
	    for(var i2 = 0; i2 < 5; i2++){	
	    	for(var i = 0; i < 3; i++){
	    		if(i2 <= 2){
	    			...
	    			List_Result_2_Images_Texture[i2].GetComponent<SpriteRenderer>().sprite = Resources.Load(""+List_Main_Menu_2_Container_Images_Texture[i2], typeof(Sprite)) as Sprite;
	    		...
	    		if(i2 == 3){
	    			...
	    			List_Result_2_Images_Texture[i2].GetComponent<SpriteRenderer>().sprite = Resources.Load(""+List_Main_Menu_2_Container_Images_Texture[List_Main_Menu_2_Container_Images_Texture.Count - 2], typeof(Sprite)) as Sprite;	
	    		...
	    		if(i2 == 4){
	    			...
	    			List_Result_2_Images_Texture[i2].GetComponent<SpriteRenderer>().sprite = Resources.Load(""+List_Main_Menu_2_Container_Images_Texture[List_Main_Menu_2_Container_Images_Texture.Count - 1], typeof(Sprite)) as Sprite;	
